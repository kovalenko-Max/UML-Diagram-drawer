...
{
    public class ArrowCompositionFactory : IArrowsFactory
    {
        ...
        {
            return new Arrow(arrow, new SolidArrowLine(), arrowHead: new ThreePointArrowHead(), arrowNock: new FilledRhombus());
        }
    }
}